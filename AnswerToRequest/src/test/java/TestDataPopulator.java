    ...
    DASData<ProducerTime> producersData;
     ...
     public TestDataPopulator() {
        this.producersData = ProducersDBFactory.getDbInstance();
         ...
         producersData.getData().add( new ProducerTime("P10", "1", "2018-09-10", "2018-09-15", "1", "24"));
         producersData.getData().add( new ProducerTime("P11", "2", "2018-09-01", "2018-10-15", "2", "12"));
         producersData.getData().add( new ProducerTime("P12", "1", "2018-09-10", "2018-09-12", "3", "18"));
         producersData.getData().add( new ProducerTime("P13", "2", "2018-09-20", "2018-10-01", "1", "24"));
         producersData.getData().add( new ProducerTime("P13", "2", "2018-09-20", "2018-10-01", "1", "24"));

     }

//   public  void putProducerData ( DASData<ProducerTime> producersData) {
//        producersData.getData().add( new ProducerTime("P10", "1", "2018-09-10", "2018-09-15", "1", "24"));
//        producersData.getData().add( new ProducerTime("P11", "2", "2018-09-01", "2018-10-15", "2", "12"));
//        producersData.getData().add( new ProducerTime("P12", "1", "2018-09-10", "2018-09-12", "3", "18"));
//        producersData.getData().add( new ProducerTime("P13", "2", "2018-09-20", "2018-10-01", "1", "24"));
